...
def main():
    minst_instances = read_vnncomp_instances("cifar2020", Path("./vnncomp/vnncomp2022/benchmarks"))
    result_summary = {
            "TOTAL_RUNTIME": 0,
    ...
    try:
        ...
        for index, instance in enumerate(minst_instances):
            ...
            print(f"Verifying instance {index+1} of {len(minst_instances)}: {instance.network.stem} {instance.property.stem}")
